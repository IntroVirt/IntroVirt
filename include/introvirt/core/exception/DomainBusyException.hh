...
/**
 * @brief Thrown when failing to attach to a domain because it was busy
 *
 * This usually indicates that another introvirt tool is attached.
 */
class DomainBusyException final : public TraceableException {
  public:
    /**
     * @brief Construct a new Domain Busy Exception object
     *
     * @param domain_id The domain_id
     */
