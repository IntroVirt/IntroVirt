...
/**
 * @brief Handler for ws2_32!getsockname
 *
 * @see https://docs.microsoft.com/en-us/windows/win32/api/winsock/nf-winsock-getsockname
 */
class getsockname : public WindowsFunctionCall {
  public:
    /* Input arguments */
    SOCKET s() const;
    void s(SOCKET s);
    ...
    GuestVirtualAddress pNameLen() const;
    void pNameLen(const GuestVirtualAddress& gva);

    /* Helpers */

    /**
     * @brief Get the SOCKADDR structure
     * @throw InvalidMethodException if the call has not returned yet
    ...
    inline static const std::string FunctionName = "getsockname";

  private:
    SOCKET s_;
    GuestVirtualAddress pName_;
    GuestVirtualAddress pNameLen_;
