...
/**
 * @brief Handler for ws2_32!recv
 *
 * @see https://docs.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-recv
 */
class recv : public WindowsFunctionCall {
  public:
    /* Input arguments */
    SOCKET s() const;
    void s(SOCKET s);
    ...
    inline static const std::string FunctionName = "recv";
