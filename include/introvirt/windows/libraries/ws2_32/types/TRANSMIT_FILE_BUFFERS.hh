...
/**
 * @brief
 * @see https://docs.microsoft.com/en-us/windows/win32/api/mswsock/ns-mswsock-transmit_file_buffers
 */
class TRANSMIT_FILE_BUFFERS {
  public:
    ...
    /**
     * @brief Create a TRANSMIT_FILE_BUFFERS
     */
