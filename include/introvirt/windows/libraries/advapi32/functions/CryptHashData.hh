...
/**
 * @brief Handler for advapi32!CryptHashData
 *
 * @see https://docs.microsoft.com/en-us/windows/win32/api/wincrypt/nf-wincrypt-cryptcreatehash
 */
class CryptHashData final : public WindowsFunctionCall {
  public:
    /* Input arguments */
    ...
    inline static const std::string FunctionName = "CryptHashData";
