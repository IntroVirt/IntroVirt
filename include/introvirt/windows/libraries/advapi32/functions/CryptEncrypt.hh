...
/**
 * @brief Handler for advapi32!CryptEncrypt
 *
 * @see https://docs.microsoft.com/en-us/windows/win32/api/wincrypt/nf-wincrypt-cryptencrypt
 */
class CryptEncrypt final : public WindowsFunctionCall {
  public:
    /* Input arguments */
    ...
    uint32_t dwBufLen() const;
    void dwBufLen(uint32_t value);
    ...
    CryptEncrypt(Event& event);
    ~CryptEncrypt() override;

    static constexpr int ArgumentCount = 7;
    inline static const std::string LibraryName = "advapi32";
    inline static const std::string FunctionName = "CryptEncrypt";
