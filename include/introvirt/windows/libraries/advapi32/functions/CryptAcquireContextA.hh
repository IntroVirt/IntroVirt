...
/**
 * @brief Handler for advapi32!CryptAcquireContextA
 *
 * @see https://docs.microsoft.com/en-us/windows/win32/api/wincrypt/nf-wincrypt-cryptacquirecontexta
 */
class CryptAcquireContextA final : public WindowsFunctionCall {
  public:
    /* Input arguments */
    ...
    ~CryptAcquireContextA() override;

    static constexpr int ArgumentCount = 5;
    inline static const std::string LibraryName = "advapi32";
    inline static const std::string FunctionName = "CryptAcquireContextA";
