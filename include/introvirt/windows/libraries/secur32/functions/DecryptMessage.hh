...
/**
 * @brief Handler for crypt32!DecryptMessage
 *
 * @see https://docs.microsoft.com/en-us/windows/win32/secauthn/DecryptMessage--schannel
 */
class DecryptMessage : public WindowsFunctionCall {
  public:
    /* Input arguments */
    ...
    GuestVirtualAddress pfQOP() const;
    void pfQOP(const GuestVirtualAddress& pfQOP);
