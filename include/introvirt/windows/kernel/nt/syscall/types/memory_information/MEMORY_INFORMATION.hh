...
#include "MEMORY_INFORMATION_CLASS.hh"
...
/**
 * @brief An abstract class reprseneting a more specific memory information buffer.
 *
 */
class MEMORY_INFORMATION {
  public:
    /**
     * @brief Get the type of memory information held in the buffer
     *
     * @return MEMORY_INFORMATION_CLASS
     */
    ...
    /**
     * @brief Return the memory information class as a JSON representation
     *
     * @return Json::Value
     */
     ...
     */
    static std::unique_ptr<MEMORY_INFORMATION>
    make_unique(const NtKernel& kernel, MEMORY_INFORMATION_CLASS information_class,
