...
#include "FILE_INFORMATION_CLASS.hh"
...
/**
 * @brief An abstract class reprseneting a more specific file information buffer.
 *
 */
class FILE_INFORMATION {
  public:
    /**
     * @brief Get the type of file information held in the buffer
     *
     * @return FILE_INFORMATION_CLASS
     */
    ...
    /**
     * @brief Return the file information class as a JSON representation
     *
     * @return Json::Value
     */
     ...
     */
    static std::unique_ptr<FILE_INFORMATION> make_unique(const NtKernel& kernel,
