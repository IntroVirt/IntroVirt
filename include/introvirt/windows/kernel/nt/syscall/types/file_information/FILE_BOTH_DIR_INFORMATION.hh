...
class FILE_BOTH_DIR_INFORMATION : public FILE_INFORMATION {
  public:
    using iterator = offset_iterator<FILE_BOTH_DIR_INFORMATION_ENTRY, false>;
    using const_iterator = offset_iterator<FILE_BOTH_DIR_INFORMATION_ENTRY, true>;
