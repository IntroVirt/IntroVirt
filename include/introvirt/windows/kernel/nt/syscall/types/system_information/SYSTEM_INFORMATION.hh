...
#include "SYSTEM_INFORMATION_CLASS.hh"
...
class SYSTEM_INFORMATION {
  public:
    /**
     * @brief Get the type of system information held in the buffer
     *
    ...
    /**
     * @brief Create a SYSTEM_INFORMATION instance.
     *
    ...
    make_unique(const NtKernel& kernel, SYSTEM_INFORMATION_CLASS information_class,
