...
#include "FS_INFORMATION_CLASS.hh"
...
/**
 * @brief An abstract class reprseneting a more specific filesystem information buffer.
 *
 */
class FS_INFORMATION {
  public:
    /**
     * @brief Get the type of filesystem information held in the buffer
     *
     * @return FS_INFORMATION_CLASS
     */
     ...
     */
    static std::unique_ptr<FS_INFORMATION> make_unique(const NtKernel& kernel,
