...
#include "THREAD_INFORMATION_CLASS.hh"
...
class THREAD_INFORMATION {
  public:
    /**
     * @brief Get the type of thread information held in the buffer
     *
     * @return THREAD_INFORMATION_CLASS
     */
    ...
    /**
     * @brief Create a THREAD_INFORMATION instance.
     *
     ...
     */
    static std::unique_ptr<THREAD_INFORMATION>
    make_unique(const NtKernel& kernel, THREAD_INFORMATION_CLASS information_class,
