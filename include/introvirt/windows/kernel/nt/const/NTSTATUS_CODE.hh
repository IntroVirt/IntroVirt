...
enum NTSTATUS_CODE {
    ...
    STATUS_WINTROVIRT_UNINITIALIZED =
        0xCAFEF00DL, // This is IntroVirt specific to indicate that the status is uninitialized
    STATUS_WINTROVIRT_UNKNOWN_CODE =
        0xCAFED00FL // This is IntroVirt specific to indicate that the status is unknown
};
