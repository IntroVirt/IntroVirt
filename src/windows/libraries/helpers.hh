...
#define DEFINE_VALUE_GETTER_SETTER(classname, name, index, argtype)                                \
    argtype classname::name() const { return name##_; }                                            \
    void classname::name(argtype val) {                                                            \
        set_argument(index, val);                                                                  \
        name##_ = val;                                                                             \
    }
