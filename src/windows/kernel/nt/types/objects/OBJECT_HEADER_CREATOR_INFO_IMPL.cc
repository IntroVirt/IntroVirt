...
uint64_t OBJECT_HEADER_CREATOR_INFO_IMPL<PtrType>::CreatorUniqueProcess() const {
    return offsets_->CreatorUniqueProcess.get<PtrType>(buffer_);
}
...
template class OBJECT_HEADER_CREATOR_INFO_IMPL<uint64_t>;
