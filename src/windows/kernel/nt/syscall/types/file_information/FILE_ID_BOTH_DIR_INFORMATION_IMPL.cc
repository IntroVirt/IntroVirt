...
void FILE_ID_BOTH_DIR_INFORMATION_IMPL::write(std::ostream& os,
    ...
    for (const auto& entry : *this) {
        ...
        os << linePrefix << "\t\tFileId: " << entry.FileId() << '\n';
    }
}

Json::Value FILE_ID_BOTH_DIR_INFORMATION_IMPL::json() const {
    Json::Value result;
    ...
    for (const auto& entry : *this) {
        ...
        json_entry["FileId"] = entry.FileId();
