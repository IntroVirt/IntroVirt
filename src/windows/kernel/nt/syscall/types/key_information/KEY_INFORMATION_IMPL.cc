...
std::unique_ptr<KEY_INFORMATION> make_unique_impl(KEY_INFORMATION_CLASS information_class,
    ...
    case KEY_INFORMATION_CLASS::KeyBasicInformation:
        return std::make_unique<KEY_BASIC_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyCachedInformation:
        return std::make_unique<KEY_CACHED_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyFlagsInformation:
        return std::make_unique<KEY_FLAGS_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyFullInformation:
        return std::make_unique<KEY_FULL_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyHandleTagsInformation:
        return std::make_unique<KEY_HANDLE_TAGS_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyNameInformation:
        return std::make_unique<KEY_NAME_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyNodeInformation:
        return std::make_unique<KEY_NODE_INFORMATION_IMPL>(ptr, buffer_size);
    case KEY_INFORMATION_CLASS::KeyVirtualizationInformation:
        return std::make_unique<KEY_VIRTUALIZATION_INFORMATION_IMPL>(ptr, buffer_size);
    }

    return std::make_unique<KEY_INFORMATION_IMPL>(information_class, ptr, buffer_size);
}
