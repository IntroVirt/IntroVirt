...
static std::unique_ptr<PROCESS_INFORMATION> make_unique_impl(PROCESS_INFORMATION_CLASS info_class,
    ...
    case PROCESS_INFORMATION_CLASS::ProcessBasicInformation:
        return std::make_unique<PROCESS_BASIC_INFORMATION_IMPL<PtrType>>(ptr, buffer_size);
    case PROCESS_INFORMATION_CLASS::ProcessCookie:
        return std::make_unique<PROCESS_COOKIE_INFORMATION_IMPL>(ptr, buffer_size);
    case PROCESS_INFORMATION_CLASS::ProcessDefaultHardErrorMode:
        return std::make_unique<PROCESS_DEFAULT_HARD_ERROR_MODE_INFORMATION_IMPL>(ptr, buffer_size);
    case PROCESS_INFORMATION_CLASS::ProcessImageFileName:
        return std::make_unique<PROCESS_IMAGE_FILE_NAME_INFORMATION_IMPL<PtrType>>(ptr,
                                                                                   buffer_size);
    ...
    case PROCESS_INFORMATION_CLASS::ProcessWindowInformation:
        return std::make_unique<PROCESS_WINDOW_INFORMATION_IMPL>(ptr, buffer_size);
    case PROCESS_INFORMATION_CLASS::ProcessWow64Information:
        return std::make_unique<PROCESS_WOW64_INFORMATION_IMPL>(ptr, buffer_size);
    case PROCESS_INFORMATION_CLASS::ProcessPriorityClass:
        return std::make_unique<PROCESS_PRIORITY_CLASS_INFORMATION_IMPL>(ptr, buffer_size);
    }

    return std::make_unique<PROCESS_INFORMATION_IMPL<>>(info_class, ptr, buffer_size);
}
