...
/**
 * @brief Generic base class for section information
 *
 */
template <typename _BaseClass = SECTION_INFORMATION, typename _StructType = char>
class SECTION_INFORMATION_IMPL : public _BaseClass {
  public:
    void write(std::ostream& os, const std::string& linePrefix = "") const override {
        os << linePrefix << "SectionInformationClass: " << SectionInformationClass() << '\n';
    }
    Json::Value json() const override {
        Json::Value result;
        result["SectionInformationClass"] = to_string(SectionInformationClass());
        return result;
    }
